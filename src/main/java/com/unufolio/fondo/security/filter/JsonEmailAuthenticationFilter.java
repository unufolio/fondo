...
public class JsonEmailAuthenticationFilter extends EmailAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request,
        ...
        if (request.getContentType().contains(MediaType.APPLICATION_JSON_VALUE)) {
            ...
            try (InputStream inputStream = request.getInputStream()) {
                ...
                String email = this.obtainEmail(jsonNode);
                ...
                authRequest = new EmailAuthenticationToken(email, "", code);
    ...
    @Nullable
    protected String obtainEmail(JsonNode jsonNode) {
        return jsonNode.get(super.emailParameter).asText();
    }
