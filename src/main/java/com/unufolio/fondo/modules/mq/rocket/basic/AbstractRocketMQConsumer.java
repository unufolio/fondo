...
public abstract class AbstractRocketMQConsumer {
    ...
    private final static Logger logger = LoggerFactory.getLogger(AbstractRocketMQConsumer.class);
    ...
    public AbstractRocketMQConsumer(String tag, String topic, String groupName, String consumerGroup) {
        this.tag = tag;
        this.topic = topic;
